	...
	****/
	...
	setupEnemies: function(){
		...
		this.enemyPool.setAll(
			...
			'dropRate', BasicGame.ENEMY_DROP_RATE, false, false, 0, true  //30% chance of droping powerup
		);
		...
		this.shooterPool.setAll(
			...
			'dropRate', BasicGame.SHOOTER_DROP_RATE, false, false, 0, true //50% chance of droping powerup
		);
	...
	processDelayedEffects: function(){
	    ...
	    if(this.bossApproaching && this.boss.x  > this.game.width / 2){
	...
	spawnBoss: function(){
		...
		this.boss.reset( this.game.width, this.game.height / 2, 0, BasicGame.BOSS_HEALTH);
